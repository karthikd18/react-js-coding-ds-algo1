...
//console.log(Object.entries(strB),Object.entries(strA),item)
      let strAresult  = Object.entries(strA).filter((f,index)=>{return( f[0] === item[0] && f[1] === item[1] )})
if(!strAresult){
  result = false
}
   //   console.log(strAresult )
    ...
    //  console.log(Object.entries(strB),Object.entries(strA),item)
            let strAresult  = Object.entries(strB).filter((f,index)=>{return( f[0] === item[0] && f[1] === item[1] )})
      if(!strAresult){
        result = false
      }
            console.log(strAresult )
